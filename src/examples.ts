...
import { adjacentDifference, adjacentFind, greater, lesser } from "./index";
...
// console.log(adjacentFind(0, 4, [0, 1, 2, 4, 3, 2, 4, 4], lesser)); // 1
// console.log(adjacentFind(0, 4, [0, 1, 2, 4, 3, 2, 4, 4], greater)); // 4
